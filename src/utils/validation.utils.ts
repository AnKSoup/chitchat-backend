...
// RETURNS bool
export function isOnlyWord(word: string, string: string) {
...
export function isOnlyFirstWord(string: string) {
...
export function isOnlyQuery(string: string) {
    const check = string.toUpperCase();
...
export function allowOnly(object: Object, array: Array<string>) {
...
export function prevents(object: Object, array: Array<string>) {
    const obj = Object.keys(object);            //Gets values.
    const arr = array;
...
export function isTokenOfID(token: string, id: any) {
