...
import { isTokenOfOwner, isTokenOfUser, isTokenValid, } from "../services/tokens.service.js";
...
import { createMessage, deleteMessage, editMessage, getMessagesFromConv, isMessageInConv, isMessageOfId, } from "../services/db/message.service.js";
// ENDPOINTS :
...
routeMessage.post("/:conversation_id", async (req, res) => {
    ...
    if (validateOperation(res, member))
        return;
