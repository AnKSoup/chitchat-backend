...
export function isPasswordValid(password) {
    if (passwordValidator.test(password)) {
        ...
        return iro(false, "Invalid password.", 400, "Ensure that the password contains the following: at least 1 digit, 1 lowecase, 1 uppercase, and 1 special character, no white spaces and between 8 and 20 characters total.");
}
